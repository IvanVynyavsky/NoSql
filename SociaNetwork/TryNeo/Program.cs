...
public class Social
{
    ...
    //public Social()
    //{
    //   // var driver = GraphDatabase.Driver(new Uri("bolt://localhost:7687"), AuthTokens.Basic("neo4j", "socialnetwork"));
    //    _graphClient = new GraphClient(new Uri("http://localhost:7474/socialnetworkgraph/data"), "neo4j", "1111");
